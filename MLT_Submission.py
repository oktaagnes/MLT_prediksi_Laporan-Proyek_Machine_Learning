# -*- coding: utf-8 -*-
"""MLT_Submission_1__(1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1w5aeta67nhPOHDYSRE45mWNo73ZcgEL1
...
"""#### <div align="left"><span style="white-space: pre-wrap; font: normal 11pt Arial; line-height: 1.5;">**Insight:**<br>Terdapat 8 kolom yaitu, N, P, K, Temperature, Humadity, ph, rainfall, dan label.</li></ul></span></div>
...
Memuat info nama Baris di dataset kolom label
"""
...
"""Visualisasi Perbandingan Kandungan N, P, K antar Label Pupuk"""
...
"""Visualisasi perbandingan rata rata tingkat *temperature*, *humidity*, dan *rainfall* antar setiap label"""
...
"""####  <div align="left"><span style="white-space: pre-wrap; font: normal 11pt Arial; line-height: 1.5;">**Keterangan**: <br>Tidak ada data duplikat pada dataframe.</span></div>
...
"""####  <div align="left"><span style="white-space: pre-wrap; font: normal 11pt Arial; line-height: 1.5;">**Keterangan**: <br>tidak ada data outliers.</span></div>
...
# didapatkan nilai k optimal adalah 7
print("Minimum error:-", min(list_mse), " pada K =", list_mse.index(min(list_mse)) + 1)
...
"""####  <div align="left"><span style="white-space: pre-wrap; font: normal 11pt Arial; line-height: 1.5;">**Insight**: <br>Dari kode di atas dapat dilihat bahwa model dengan algoritma K-Nearest Neighbor memperoleh nilai akurasi yaitu sebesar 97.99331257926899 dengan k = 7.</span></div>
...
# Menghasilkan classification report
report = classification_report(y_test, xgb_predictions, output_dict=True, target_names=label_encoder.classes_)
...
"""####  <div align="left"><span style="white-space: pre-wrap; font: normal 11pt Arial; line-height: 1.5;">**Insight**: <br>Dari gambar di atas, terlihat bahwa, model RandomForest memberikan nilai eror (MSE) yang paling kecil. Sedangkan model algoritma Boosting memiliki eror yang paling besar. Sebelum memutuskan model terbaik untuk melakukan prediksi Quality. Mari kita coba uji prediksi menggunakan beberapa sampel acak pada data uji..</span></div>"""
